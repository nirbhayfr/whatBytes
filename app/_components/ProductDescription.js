...
function ProductDescription({ id }) {
     ...
     return (
          <div className="bg-white">
               <div className="grid grid-cols-[1fr_2fr] gap-12 p-8">
                    <img
                    ...
                    <div className="grid grid-rows-[auto_1fr]">
                         ...
                         <div className="flex items-end w-full">
                              <div className="flex gap-4 text-2xl items-center w-full">
                                   ...
                                   <button
                                        className="flex items-center justify-center bg-blue-800 rounded-[10rem] text-white px-4 py-2 cursor-pointer hover:bg-blue-600 transition-all duration-300 disabled:opacity-20"
                                        onClick={() =>
                                             setQuantity((val) => --val)
                                        }
                                        disabled={quantity < 2}
